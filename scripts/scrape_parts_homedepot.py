#!/usr/bin/env python3
"""
Scrape Home Depot plumbing catalog pages into parts_catalog with embeddings.
"""
...
HOMEDEPOT_CATEGORY_URLS = [
    "https://www.homedepot.com/b/Plumbing-Water-Heaters-Tank-Water-Heaters/N-5yc1vZc48s",
    "https://www.homedepot.com/b/Plumbing-Water-Heaters-Tankless-Water-Heaters/N-5yc1vZc489",
    "https://www.homedepot.com/b/Bath-Toilets/N-5yc1vZbzbc",
    "https://www.homedepot.com/b/Kitchen-Kitchen-Faucets/N-5yc1vZbqn8",
    "https://www.homedepot.com/b/Bath-Bathroom-Faucets/N-5yc1vZbqoy",
    "https://www.homedepot.com/b/Appliances-Garbage-Disposals/N-5yc1vZc3jg",
    "https://www.homedepot.com/b/Plumbing-Sump-Pumps/N-5yc1vZbqp2",
    "https://www.homedepot.com/b/Plumbing-Water-Softeners/N-5yc1vZcfj4",
    "https://www.homedepot.com/b/Bath-Showerheads-Shower-Faucets/N-5yc1vZbzb3",
    "https://www.homedepot.com/b/Plumbing-Pipe-Fittings-PEX-Pipe/N-5yc1vZbusj",
]
...
def parse_products_with_claude(
    ...
    prompt = f"""Extract Home Depot plumbing products from this category listing page.
...
- Prefer plumbing fixtures, parts, and equipment.
...
def deterministic_id(row: ProductRow) -> str:
    basis = f"homedepot|{row.brand.lower()}|{row.name.lower()}|{row.sku or ''}"
...
def with_page(url: str, page: int) -> str:
    if page <= 1:
        return url
    sep = "&" if "?" in url else "?"
    return f"{url}{sep}Nao={24 * (page - 1)}"


def main() -> None:
    parser = argparse.ArgumentParser(description="Scrape Home Depot parts into parts_catalog")
    ...
    target_urls = args.url if args.url else HOMEDEPOT_CATEGORY_URLS
    ...
    for base_url in target_urls:
        ...
        for page in range(1, max(1, args.max_pages) + 1):
            ...
            try:
                ...
                for row in limited:
                    emb_text = (
                        f"source=homedepot; brand={row.brand}; name={row.name}; category={row.category}; "
